...
export default function Popup({ onDelete, onEdit }) {
  return (
    <div className="absolute bottom-full mb-2 right-2 text-tuatara-50 w-32 bg-tuatara-700 rounded-lg shadow-lg p-2">
      <div className="flex flex-col space-y-2">
        <div
          className="flex flex-row justify-between items-center p-2 hover:bg-tuatara-800"
          onClick={() => {
            onEdit();
          }}
          // onClick={() =>
          //   navigate(`${URI_PATH.valuationEditPage}/?id=${valuationId}`)
          // }
        >
